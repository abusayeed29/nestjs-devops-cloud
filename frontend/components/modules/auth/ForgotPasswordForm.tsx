  ...
  return (
    <div className="min-h-screen bg-[#eff4fb] flex items-center justify-center px-4 py-8">
      <div className="bg-white rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.08)] p-10 w-full max-w-[480px]">
        ...
        {/* Heading */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-[#1a1a2e] text-center mb-1">Forgot Your Password?</h1>
          <p className="text-[15px] text-[#8a94a6] text-center">Enter your email and we&apos;ll send you a link to reset your password.</p>
        </div>
